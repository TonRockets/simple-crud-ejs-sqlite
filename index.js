...
app.get('/admin/novavaga', async (req, res) => {
    const db = await dbConnection
    const categorias = await db.all('select * from categorias;')
    res.render('admin/nova-vaga', {categorias})
})

app.post('/admin/novavaga', async (req, res) => {
...
app.get('/admin/novacategoria', async (req, res) => {
    const db = await dbConnection
    await db.all('select * from categorias')
...
const init = async () => {
    ...
    // // const categoria = ''
    // // await db.run(`insert into categorias(categoria) values('${categoria}')`)
    // const vaga = 'Front-end'
    // const descricao = 'Vaga para Front-end developer with React.js + Redux'
